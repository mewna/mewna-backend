...
package com.mewna.plugin.plugins.dnd.dice.roller.random;
 ...
 * <p>
 * The com.mewna.plugin.plugins.dnd.dice.generated numbers will be integers in a closed interval, beginning at 1
 * and ending in a specified maximum value.
 * 
 * @author Bernardo Martínez Garrido
 */
public final class RandomNumberGenerator implements com.mewna.plugin.plugins.dnd.dice.roller.random.NumberGenerator {
     ...
     * 
     * @param max
     *            the maximum value which can be com.mewna.plugin.plugins.dnd.dice.generated
